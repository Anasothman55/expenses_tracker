...
from src.infrastructure.db.models.currencies import CurrenciesModelValidation, CurrenciesModel
from src.modules.currencies.schema import CurrenciesCreateSchema
